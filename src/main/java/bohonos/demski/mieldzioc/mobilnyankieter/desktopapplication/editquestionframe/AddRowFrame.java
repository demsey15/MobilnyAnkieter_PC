...
public class AddRowFrame extends JFrame implements ActionListener {
    ...
    private EditQuestionFrame editQuestionFrame;
    ...
    public AddRowFrame(EditQuestionFrame editQuestFrame) throws IOException, ParseException {
        
        super("Dodaj etykietê wiersza");
        
        applicationLogic = ApplicationLogic.getInstance();
        editQuestionFrame = editQuestFrame;
        ...
        rowLabel.setBounds(LABEL_X_POSITION, LABEL_Y_POSITION, LABEL_WIDTH, LABEL_HEIGHT);
        this.add(rowLabel);
         
        rowField = new JTextField();
        rowField.setBounds(FIELD_X_POSITION, FIELD_Y_POSITION, FIELD_WIDTH, FIELD_HEIGHT);
        this.add(rowField);
