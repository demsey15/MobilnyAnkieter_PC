...
public class OneChoiceQuestion extends Question {
	...
	private boolean isDropDownList = false;

	/**
	 * Create OneChoiceQuestion object with isDropDownList as false and
	 * obligatory as true.
	 * 
	 * @param question
	 *            text of question
	 ...
	 *            true if answer this question is obligatory
	 * @param answers
	 *            lists of question's answers
	 * @param isDropDownList
	 *            true if question should be presented as drop-down list
	 * @throws NullPointerException
	 *             jeœli przekazana lista odpowiedzi jest nullem.
	 */
	public OneChoiceQuestion(String question, boolean obligatory, List<String> answers, boolean isDropDownList) {
		super(question, obligatory);
		if (answers == null)
			throw new NullPointerException("Lista odpowiedzi nie moze byæ nullem!");
	 ...
	 * 
	 * @param isDropDownList
	 *            true if this question should be performed as drop-down list
	 */
	...
	public boolean equals(Object o) {
		...
		return super.equals(o2) && Objects.equals(answers, o2.answers) && Objects.equals(userAnswer, o2.userAnswer)
